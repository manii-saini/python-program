...
def main():
    while True:
        print("\nScientific Calculator with Random Functions")
        print("1. Addition")
        print("2. Subtraction")
        ...
        print("9. Tangent")
        print("10. Factorial")
        print("11. Generate Random Integer")
        print("12. Generate Random Float")
        print("13. Exit")
        ...
        if choice in ['1', '2', '3', '4', '5']:
            ...
            print("Random Integer:", random_integer(start, end))
